      ...
      <div class="project-main">
        <div id="info" class="project-main-info">
          <div class="info-restrictor">
            <div class="headline-info"> THIS IS A HEADLINE </div>
            <div class="color-bar-info"> </div>
            <div class="copy-info"> lorem ipsum dolor sit amet, consectetur adipiscing elit. donec consequat ultricies dictum. nam sit amet diam quis augue sodales bibendum. donec tempus ligula in tortor commodo posuere. nam interdum dictum urna et sagittis. duis turpis ipsum, imperdiet et sodales eget, malesuada ac arcu. donec sed mauris libero. </div>
          </div>
        </div>
        <div id="toggle" class="project-main-info-toggle" >
          <div class="project-main-info-toggle-triangle"> </div>
        ...
        <?php while( have_rows('gallery') ): the_row(); 
                    ...
                    $number_b = 1;
                    ?>
        <div class="project-image b<?php echo ++$nuber_b; ?>" style=" background-image:url(<?php echo $image; ?>); background-size:cover; background-position:center;"> </div>
        <?php endwhile; ?>
        <?php else: ?>
        <?php endif; ?>
      </div>
      ...
      <div class="scroller">
        <div class="project-gallery">
          <?php while( have_rows('gallery') ): the_row(); 
                        ...
                        $number = 1;
                        ?>
          <div class="project-thumb a<?php echo ++$nuber; ?>" style=" background-image:url(<?php echo $image; ?>); background-size:cover; background-position:center;"> </div>
          <?php endwhile; ?>
        </div>
      </div>
      <?php  endif; ?>
